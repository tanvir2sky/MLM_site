<div class="content-wrapper">
   <section class="content-header">
          <h1>
           Add New Youtube Video For Viewing
    ...
    <br />
        <section class="content">
            <form role="form" action="<?php echo base_url(); ?>admin/addYoutubePageToDb" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" required="" name="moneynormal">
                        ...
                        <div class="form-group">
                      <label for="exampleInputPassword1">View Limit</label>
